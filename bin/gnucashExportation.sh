        ...
        "type_mapping": {
            "transaction" : {
                "properties" : {
                    ...
                    "date" : {"type" : "date", "format": "YYYYMMddHHmmss"},
